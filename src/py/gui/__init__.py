...
class MainWindow(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        # 给容器加透明度特效
        self.logo_opacity_effect: QtWidgets.QGraphicsOpacityEffect = (
            QtWidgets.QGraphicsOpacityEffect(self.logo_container)
        )
        self.logo_container.setGraphicsEffect(self.logo_opacity_effect)
        self.logo_opacity_effect.setOpacity(0.0)

        # 添加logo本体
        self.logo: LogoLabel = LogoLabel(
            resource_path(os.path.join("data", "static", "png", "logo_gradient.png")),
            self.logo_container
        )
        self.logo.move(0, 0)
        self.logo.show()
